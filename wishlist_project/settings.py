...
ZARINPAL_CALLBACK_URL = 'http://your-domain.com/api/payments/verify/'
...
CELERY_BROKER_URL = 'redis://localhost:6000/0'
CELERY_RESULT_BACKEND = 'redis://localhost:6000/0'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://localhost:6000/1',
    }
}
